...
const BlogEditor = lazy(() => import('./components/CMS/BlogEditor'));
    ...
    <Router>
      ...
      <Suspense fallback={<PageLoader />}>
        <Routes>
          ...
          <Route path="/cms/blog-editor" element={<BlogEditor />} />
...
/>
          ...
          {/* Dynamic CMS Routes (fallback for non-hardcoded slugs) */}
          <Route path="/products/:slug" element={<DynamicPage type="products" />} />
          <Route path="/services/:slug" element={<DynamicPage type="services" />} />
          <Route path="/industries/:slug" element={<DynamicPage type="industries" />} />
          <Route path="/research-development/:slug" element={<DynamicPage type="rd" />} />

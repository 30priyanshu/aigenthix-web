...
const WELCOME_MSG =
  "Hi! I'm the AiGENThix assistant. Ask me about our services, products, industries, principles, or contact details. What would you like to explore?";
...
const ChatbotWidget = () => {
  ...
  const handleSend = async () => {
    ...
    try {
      const answer = await getAnswer(text, messages);

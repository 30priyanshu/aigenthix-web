...
| GEMINI_API_KEY | No | Primary Gemini API key for the chatbot |
| GEMINI_API_KEY_2 | No | Optional fallback Gemini API key used when the primary key is rate limited or unavailable |

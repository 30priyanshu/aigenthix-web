    ...
    def create(self, blog_data: BlogCreate) -> int:
        ...
        query = """
            INSERT INTO blogs (
                ...
                featured_image_url, author_name, author_title, author_bio, author_avatar_url,
                author_twitter, author_linkedin, author_facebook,
                author_instagram, author_github, author_website,
                fact_checker_name, fact_checker_bio, fact_checker_avatar_url,
                faqs,
        ...
        params = (
            ...
            blog_data.fact_checker_name, blog_data.fact_checker_bio, blog_data.fact_checker_avatar_url,
            faqs_json,
    ...
    def update(self, blog_id: int, blog_data: BlogUpdate) -> bool:
        ...
        query = """
            UPDATE blogs SET
                ...
                author_name = %s, author_title = %s, author_bio = %s, author_avatar_url = %s,
                author_twitter = %s, author_linkedin = %s,
                author_facebook = %s, author_instagram = %s,
                author_github = %s, author_website = %s,
                fact_checker_name = %s, fact_checker_bio = %s, fact_checker_avatar_url = %s,
                faqs = %s,
